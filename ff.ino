...
void loop() {
  if(BTSerial.available() > 0) {
    ...
    if(val == ';') {
      ...
      // Braccio.ServoMovement(30, Motors[0].currentAngle, Motors[1].currentAngle, Motors[2].currentAngle, Motors[3].currentAngle, Motors[4].currentAngle, Motors[5].currentAngle);
